...
public class SocketApi {
  ...
  */
  public InlineResponse20022 socketUserEnteredWhatsAppPost () throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;

    // create path and map variables
    String path = "/socket/user-entered-WhatsApp";
  ...
  */
  public void socketUserEnteredWhatsAppPost (final Response.Listener<InlineResponse20022> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;


    // create path and map variables
    String path = "/socket/user-entered-WhatsApp".replaceAll("\\{format\\}","json");
