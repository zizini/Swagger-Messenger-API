...
public class InlineResponse200User {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? inlineResponse200User.id == null : this.id.equals(inlineResponse200User.id)) &&
        (this.firstName == null ? inlineResponse200User.firstName == null : this.firstName.equals(inlineResponse200User.firstName)) &&
        (this.lastName == null ? inlineResponse200User.lastName == null : this.lastName.equals(inlineResponse200User.lastName)) &&
        (this.phone == null ? inlineResponse200User.phone == null : this.phone.equals(inlineResponse200User.phone)) &&
        (this.countryCode == null ? inlineResponse200User.countryCode == null : this.countryCode.equals(inlineResponse200User.countryCode)) &&
        (this.email == null ? inlineResponse200User.email == null : this.email.equals(inlineResponse200User.email)) &&
        (this.profilePictureString == null ? inlineResponse200User.profilePictureString == null : this.profilePictureString.equals(inlineResponse200User.profilePictureString)) &&
        (this.avatar == null ? inlineResponse200User.avatar == null : this.avatar.equals(inlineResponse200User.avatar)) &&
        (this.verified == null ? inlineResponse200User.verified == null : this.verified.equals(inlineResponse200User.verified)) &&
        (this.passcode == null ? inlineResponse200User.passcode == null : this.passcode.equals(inlineResponse200User.passcode)) &&
        (this.passcodeExpiration == null ? inlineResponse200User.passcodeExpiration == null : this.passcodeExpiration.equals(inlineResponse200User.passcodeExpiration)) &&
        (this.socketId == null ? inlineResponse200User.socketId == null : this.socketId.equals(inlineResponse200User.socketId)) &&
        (this.relationshipStatus == null ? inlineResponse200User.relationshipStatus == null : this.relationshipStatus.equals(inlineResponse200User.relationshipStatus));
  }
